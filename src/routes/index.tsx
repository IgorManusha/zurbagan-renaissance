...
const features = [
  ...
  { icon: Headphones, title: "Підтримка 24/7", desc: "Жива лінія, email та особистий кабінет" },
  { icon: Award, title: "З 1995 року", desc: "30+ років досвіду в Конотопі" },
];
...
const news = [
  ...
  { date: "02.06.2025", title: "Інструкція з додавання E-mail у кабінеті", excerpt: "Додавайте e-mail та номер у особистому кабінеті, щоб отримувати сповіщення про стан балансу." },
];
